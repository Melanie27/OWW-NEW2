								...
								<div class="row">
									<section class="col-lg-4 col-md-4 col-sm-6 col-xs-12 case-studies">
										...
										<ul class="news-thumbnails">
											<li class="clearfix">
												<img src="images/government/industry-insights/case-studies-tb-01.jpg" alt="latest-news-tb-01" class="pull-left">
												<p class="date">Oct 5, 2013</p>
												<p class="headline">Lorem Ipsum Dolore Sit Amet Oakwood</p>
											</li>
											<li class="clearfix">
												<img src="images/government/industry-insights/case-studies-tb-02.jpg" alt="latest-news-tb-01" class="pull-left">
												<p class="date">Oct 5, 2013</p>
												<p class="headline">Lorem Ipsum Dolore Sit Amet Oakwood</p>
											</li>
											<li class="clearfix">
												<img src="images/government/industry-insights/case-studies-tb-03.jpg" alt="latest-news-tb-01" class="pull-left">
												<p class="date">Oct 5, 2013</p>
												<p class="headline">Lorem Ipsum Dolore Sit Amet Oakwood</p>
											</li>
										</ul>
