...
<html lang="en">
  <head>
    ...
    <link href="_/css/mystyles_affiliations.css" rel="stylesheet" media="screen">
		...
		<?php include "_/components/php/header.php"; ?>
				...
				<section class="five container">
					<section class="row industry-affiliations">	
						...
						<section class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 col-sm-10 col-sm-offset-1 col-xs-8 col-xs-offset-2">
