					...
					<section class="col-lg-12 col-md-12 col-xs-12 no-left-padding">
						<div class="row">
							<section class="col-lg-12 col-md-12 clearfix">	
								<h1>Howard Ruby <span class="title hidden-xs">Chairman, Founder and COO</span> </h1>
								<h3 class="hidden-lg hidden-md hidden-sm">Chairman, Founder and COO</h3>
							</section>	
						</div>	
						<div class="row">
