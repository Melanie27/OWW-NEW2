							...
							<section class="three">
								<div class="row over2">
									<section class="col-lg-12 col-md-12 col-xs-12 no-left-padding">
										<div class="row">
											<section class="col-lg-8 col-md-8 clearfix">
												<h1 class="pull-left">Howard Ruby</h1>
												<h3>Chairman, Founder and COO</h3>
											</section>	
										</div>	
										<div class="row">
											<section class="col-lg-8 col-md-8">
												<img src="images/vision-leadership/_players/howard-ruby.jpg" alt="howard-ruby" class="pull-left">
