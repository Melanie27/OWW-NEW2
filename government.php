  		...
  		<section class="container landing">
		  	...
		  	<section class="two">
				...
				<?php include "_/components/php/hero-government.php"; ?>
						...
						<div class="container" >
							<section class="sub-navigation" style="display:none;">
								<div class="row">
										...
										<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
											...
											<!--<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">-->
												<ul class="nav navbar-nav">
													...
													<li><a href="#federal-civilian">Federal Civilian</a></li>
													<li><a href="#government-contractors">Government Contractors</a></li>
													<li><a href="#gsa">GSA Schedule 48</a></li>  
												</ul>
											<!--</div><!-- /.navbar-collapse -->
										</nav>
